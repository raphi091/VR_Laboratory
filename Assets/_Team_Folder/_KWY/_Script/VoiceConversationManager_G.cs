...
[System.Serializable] public class GeminiRequest_VCM { public List<Content_VCM> contents; }
[System.Serializable] public class Content_VCM { public string role; public List<Part_VCM> parts; }
[System.Serializable] public class Part_VCM { public string text; }
[System.Serializable] public class GeminiResponse_VCM { public List<Candidate_VCM> candidates; }
[System.Serializable] public class Candidate_VCM { public Content_VCM content; }
[System.Serializable] public class Secrets_VCM { public string apiKey; }
#endregion
...
public class VoiceConversationManager_G : MonoBehaviour
{
    ...
    public void StartListening()
    {
        if (!appVoiceExperience.Active && !isConversationLoading)
        {
            ...
            Debug.Log("[VoiceManager] 음성 인식을 시작합니다.");
        }
    }
    ...
    public void StopListening()
    {
        if (appVoiceExperience.Active)
        {
            ...
            Debug.Log("[VoiceManager] 음성 인식을 중지합니다.");
        }
    }
    #endregion
